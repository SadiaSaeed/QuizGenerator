...
<body>
  <nav class="site-navbar navbar navbar-default navbar-fixed-top navbar-mega navbar-expand-md"
    ...
    font-weight: bold;">
          <span  style="color: white;" id="dropdownMenuButtonRight" data-toggle="dropdown"> Sadia &nbsp;<i class="fa fa-caret-down"></i></span>
            <div class="dropdown-menu" role="menu">
              <div class="dropdown-divider" role="presentation"></div>
              <a class="dropdown-item" href="#logout" onclick="$('#logout').submit();" role="menuitem"><i class="icon wb-power" aria-hidden="true"></i> Logout</a>
            </div>
          </li>
  ...
  <div class="site-menubar">
    ...
    @if(Auth::user()->isAdmin())
        @include('layouts/backend/instructorquiz')
    @else
        @include('layouts/backend/studentquiz')
    @endif
  </div>
